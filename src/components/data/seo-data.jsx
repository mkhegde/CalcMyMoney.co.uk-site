...
export const ukCities = [
  {
    ...
    rentIndex: 100,
    description:
      "The UK's capital and largest city, known for its financial district and cultural attractions.",
  },
  {
    name: 'Manchester',
    ...
    rentIndex: 65,
    description:
      'A major city in northwest England, known for its industrial heritage and vibrant music scene.',
  },
  {
    name: 'Birmingham',
  ...
  },
  {
    ...
    rentIndex: 55,
    description:
      "Scotland's largest city, known for its Victorian architecture and cultural scene.",
  },
  {
    name: 'Liverpool',
    region: 'Merseyside',
    ...
    rentIndex: 52,
    description:
      'A major port city in northwest England, famous for The Beatles and maritime history.',
  },
  {
    name: 'Bristol',
  ...
  },
  {
    ...
    rentIndex: 75,
    description:
      "A seaside city on England's south coast, known for its pier and vibrant arts scene.",
  },
  {
    name: 'Cardiff',
    region: 'Wales',
  ...
  },
  {
    ...
    rentIndex: 80,
    description:
      "Home to the famous University of Oxford and known as the 'City of Dreaming Spires'.",
  },
  {
    name: 'Cambridge',
