    ...
    <>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span>£{Number(deposit).toLocaleString('en-GB', { maximumFractionDigits: 0 })}</span>
                            </div>
                            <div className="flex justify-between">
      ...
      <CalculatorWrapper>
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">How to Use the UK Mortgage Calculator</h2>
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">When Should You Use This Calculator?</h3>
          <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
            <li><b>Early-Stage House Hunting:</b> Get a feel for what you can afford before you start viewing properties.</li>
            <li><b>Comparing Mortgage Deals:</b> Enter details from different lenders to see how a small change in interest rate can affect your monthly payment.</li>
            <li><b>Considering Overpayments:</b> See how much you could save on interest by paying more than the required amount each month.</li>
            <li><b>Choosing a Mortgage Term:</b> Understand the trade-off between a shorter term (higher monthly payments, less total interest) and a longer term (lower monthly payments, more total interest).</li>
          </ul>

          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Example Use Case</h3>
          <p className="text-gray-700 dark:text-gray-300">
            A couple is looking to buy a house valued at £300,000. They have saved a 15% deposit of £45,000, meaning they need to borrow £255,000. They have been offered a mortgage with a 4.5% interest rate over a 30-year term. They enter these values into the calculator. The result shows a monthly repayment of approximately £1,292. The amortization chart reveals that in the early years, a large portion of their payment goes towards interest, but this gradually shifts towards paying down the principal loan amount over time. This information helps them confidently confirm that the property fits within their monthly budget.
          </p>
        </div>
      </CalculatorWrapper>
      ...
      <RelatedCalculators
        calculators={[
          { name: "Stamp Duty Calculator", url: createPageUrl("StampDutyCalculator"), description: "Calculate the property tax due on your purchase." },
          { name: "Rent vs Buy Calculator", url: createPageUrl("RentVsBuyCalculator"), description: "Compare the financial costs of renting versus buying a home." },
          { name: "Mortgage Affordability Calculator", url: createPageUrl("MortgageAffordabilityCalculator"), description: "Estimate how much you might be able to borrow." }
        ]}
      />
    </div>
    </>
