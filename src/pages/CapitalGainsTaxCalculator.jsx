            ...
            {hasCalculated && results ? (
              <>
                <div className="flex justify-between items-center non-printable">
                  <Heading as="h2" size="h2" weight="bold" className="text-gray-800">Your CGT Estimate</Heading>
                  <ExportActions
                    csvData={csvData}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between p-3 bg-gray-50 rounded">
                      ...
                      <span className="font-medium">£{results.totalGain.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between p-3 bg-gray-50 rounded">
                    ...
                    <div className="flex justify-between p-3 bg-gray-100 rounded font-bold">
                      ...
                      <span>£{results.taxableGain.toLocaleString()}</span>
                    </div>
