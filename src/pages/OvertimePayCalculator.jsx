      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid md:grid-cols-2 gap-8">
          <div className="non-printable">
            <Card>
              <CardHeader><CardTitle>Your Work Week</CardTitle></CardHeader>
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <Input id="standardHours" type="number" value={standardHours} onChange={e => setStandardHours(e.target.value)} />
                </div>
                 <div>
                  <Label htmlFor="overtimeHours">Overtime Hours per Week</Label>
                  <Input id="overtimeHours" type="number" value={overtimeHours} onChange={e => setOvertimeHours(e.target.value)} />
                </div>
                <div>
                  <Label htmlFor="overtimeMultiplier">Overtime Rate Multiplier (e.g., 1.5 for time-and-a-half)</Label>
                  <Input id="overtimeMultiplier" type="number" value={overtimeMultiplier} onChange={e => setOvertimeMultiplier(e.target.value)} />
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            {results ? (
              <div className="space-y-6">
                <Card className="bg-green-50 border-green-200">
                  <CardHeader><CardTitle className="text-green-900">Total Gross Pay</CardTitle></CardHeader>
                  <CardContent className="text-center">
                     <p className="text-5xl font-bold text-green-900">£{results.totalPay.toLocaleString('en-GB', { maximumFractionDigits: 2 })}</p>
                 ...
                 <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between items-center text-sm">
                        ...
                        <span className="font-semibold">£{results.standardPay.toLocaleString('en-GB', { maximumFractionDigits: 2 })}</span>
                    </div>
                     <div className="flex justify-between items-center text-sm">
                        <span>Overtime Pay ({overtimeHours} hrs at £{results.overtimeRate}/hr):</span>
                        <span className="font-semibold text-blue-700">£{results.overtimePay.toLocaleString('en-GB', { maximumFractionDigits: 2 })}</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
