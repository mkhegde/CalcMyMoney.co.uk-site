...
const contactFaqs = [
  {
    ...
    answer:
      'We typically respond within 1–2 business days. During peak periods (e.g., major UK Budget changes), replies may take a little longer, but we read every message.',
  },
  {
        ...
        <div className="mt-12 space-y-8">
          ...
          <section className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 mt-2">
              ...
              media enquiries, please mention “Media” in the subject line.
            </p>
          </section>
