...
const retirementFAQs = [
  {
    ...
    answer:
      "A common rule of thumb is to aim for a retirement pot of 25 times your desired annual income. For example, if you want £40,000 a year in retirement, you would aim for a £1 million pot. This calculator helps you see if you're on track.",
  },
  {
            ...
            {hasCalculated && results ? (
              <>
                <div className="flex justify-between items-center non-printable">
                  <Heading as="h2" size="h2" weight="bold" className="text-gray-800">Your Retirement Projection</Heading>
                  <ExportActions
                    csvData={csvData}
