...
const isaFAQs = [
  ...
  },
  {
    ...
    answer: "For the 2024/25 tax year, the annual ISA allowance is £20,000. You can put this into one type of ISA or split it across several different types."
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              See how your savings could grow in a tax-free ISA. Project your future balance based on your contributions and expected returns.
            </p>
          </div>
        </div>
      </div>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="initialDeposit" type="number" value={initialDeposit} onChange={(e) => setInitialDeposit(e.target.value)} className="pl-10" placeholder="e.g. 1000" />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <PoundSterling className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                    <Input id="monthlyContribution" type="number" value={monthlyContribution} onChange={(e) => setMonthlyContribution(e.target.value)} className="pl-10" placeholder="e.g. 250" />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="interestRate" type="number" value={interestRate} onChange={(e) => setInterestRate(e.target.value)} className="pl-10" placeholder="e.g. 5" />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="years" type="number" value={years} onChange={(e) => setYears(e.target.value)} className="pl-10" placeholder="e.g. 10" />
                  </div>
                </div>
            ...
            {hasCalculated && results ? (
              <>
                <div className="flex justify-between items-center non-printable">
                  ...
                  <ExportActions csvData={csvData} fileName="isa-projection" title="ISA Projection" />
                </div>
                ...
                <Card>
                  ...
                  <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-green-50 rounded-lg">
                      ...
                      <p className="text-lg font-semibold text-green-800">£{results.totalContributions.toLocaleString('en-GB', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                    </div>
                    <div className="p-4 bg-yellow-50 rounded-lg">
                      <p className="text-sm text-gray-600">Total Interest Earned</p>
                      <p className="text-lg font-semibold text-yellow-800">£{results.totalInterest.toLocaleString('en-GB', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                    </div>
                  </CardContent>
                </Card>
              </>
