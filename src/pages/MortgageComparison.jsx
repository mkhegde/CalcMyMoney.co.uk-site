...
export default function MortgageComparison() {
  ...
  const breadcrumbJson = {
    ...
    "itemListElement":[
      ...
      {"@type":"ListItem","position":3,"name":"Mortgage Comparison","item":`${origin}/MortgageComparison`}
    ]
  };
  const faqs = [
    { question: "What can I compare?", answer: "Compare rate, term, fees and total repayable between two mortgage offers." }
  ];
    ...
    <>
      ...
      <div className="bg-white">
        <div className="bg-gray-50 border-b border-gray-200 text-center py-10">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Mortgage Comparison Calculator</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="p-6 bg-gray-50 border rounded">
            <p className="text-gray-700">Calculator coming soon. Use our main Mortgage Calculator for immediate repayment estimates.</p>
          </div>
          ...
          <div className="mt-12">
            <RelatedCalculators
              calculators={[
                ...
                { name: "Mortgage Loan Repayment", url: createPageUrl("MortgageLoanRepayment"), description: "Monthly payments." },
                { name: "Home Loan Mortgage Calculator", url: createPageUrl("HomeLoanMortgageCalculator"), description: "Quick estimates." }
              ]}
            />
          </div>
        </div>
