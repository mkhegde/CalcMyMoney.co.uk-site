  ...
  const handleCalculate = () => {
    ...
    const csvExportData = [
      ...
      [
        ...
        `£${(grossSalary / 12).toFixed(2)}`,
        `£${(grossSalary / 52).toFixed(2)}`,
      ],
      ...niBreakdown.map((item) => [
        item.band,
        `£${item.amount.toFixed(2)}`,
        `£${(item.amount / 12).toFixed(2)}`,
        `£${(item.amount / 52).toFixed(2)}`,
      ]),
      [
        'Total National Insurance',
        `£${niContribution.toFixed(2)}`,
        `£${(niContribution / 12).toFixed(2)}`,
        `£${(niContribution / 52).toFixed(2)}`,
      ],
    ];
    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <CalculatorWrapper>
        <div className="space-y-6">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            Let's say you earn a gross annual salary of £40,000. Using the 2025/26 tax year rates,
            you don't pay NI on the first £12,570 of your earnings. On the portion of your salary
            between £12,570 and £40,000 (which is £27,430), you pay the main rate of 8%. This
            results in an annual NI contribution of £2,194.40. Our calculator breaks this down for
