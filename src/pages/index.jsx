...
const LazyAverageDailyBalanceCalculator = lazy(
  () => import('../calculators/average-daily-balance-calculator.jsx')
);
...
const LazyBuyToLetMortgageCalculator = lazy(
  () => import('../calculators/buy-to-let-mortgage-calculator.jsx')
);
const LazyCapitalGainsTaxCalculator = lazy(
  () => import('../calculators/capital-gains-tax-calculator.jsx')
);
...
const LazyChildBenefitCalculator = lazy(
  () => import('../calculators/child-benefit-calculator.jsx')
);
const LazyChildcareCostCalculator = lazy(
  () => import('../calculators/childcare-cost-calculator.jsx')
);
...
const LazyCompoundInterestCalculator = lazy(
  () => import('../calculators/compound-interest-calculator.jsx')
);
const LazyContractorCalculator = lazy(() => import('../calculators/contractor-calculator.jsx'));
const LazyCorporationTaxCalculator = lazy(
  () => import('../calculators/corporation-tax-calculator.jsx')
);
const LazyCostOfLivingCalculator = lazy(
  () => import('../calculators/cost-of-living-calculator.jsx')
);
const LazyDebtCalculator = lazy(() => import('../calculators/debt-calculator.jsx'));
const LazyDebtToIncomeRatioCalculator = lazy(
  () => import('../calculators/debt-to-income-ratio-calculator.jsx')
);
...
const LazyDreamLifestyleCalculator = lazy(
  () => import('../calculators/dream-lifestyle-calculator.jsx')
);
...
const LazyFirstTimeBuyerCalculator = lazy(
  () => import('../calculators/first-time-buyer-calculator.jsx')
);
...
const LazyHomeEquityLoanCalculator = lazy(
  () => import('../calculators/home-equity-loan-calculator.jsx')
);
const LazyHourlyToAnnualSalaryCalculator = lazy(
  () => import('../calculators/hourly-to-annual-salary-calculator.jsx')
);
const LazyHouseholdBillsSplitter = lazy(
  () => import('../calculators/household-bills-splitter.jsx')
);
...
const LazyMortgageAffordabilityCalculator = lazy(
  () => import('../calculators/mortgage-affordability-calculator.jsx')
);
const LazyMortgageCalculator = lazy(() => import('../calculators/mortgage-calculator.jsx'));
const LazyMortgageComparisonCalculator = lazy(
  () => import('../calculators/mortgage-comparison-calculator.jsx')
);
const LazyMortgageRepaymentCalculator = lazy(
  () => import('../calculators/mortgage-repayment-calculator.jsx')
);
...
const LazyOvertimeBonusCalculator = lazy(
  () => import('../calculators/overtime-bonus-calculator.jsx')
);
...
const LazyPercentageChangeCalculator = lazy(
  () => import('../calculators/percentage-change-calculator.jsx')
);
const LazyPersonalAllowanceCalculator = lazy(
  () => import('../calculators/personal-allowance-calculator.jsx')
);
const LazyPersonalFinanceCalculator = lazy(
  () => import('../calculators/personal-finance-calculator.jsx')
);
const LazyPersonalLoanCalculator = lazy(
  () => import('../calculators/personal-loan-calculator.jsx')
);
const LazyPresentValueCalculator = lazy(
  () => import('../calculators/present-value-calculator.jsx')
);
const LazyPricePerUnitCalculator = lazy(
  () => import('../calculators/price-per-unit-calculator.jsx')
);
const LazyProRataSalaryCalculator = lazy(
  () => import('../calculators/pro-rata-salary-calculator.jsx')
);
const LazyPropertyFlippingCalculator = lazy(
  () => import('../calculators/property-flipping-calculator.jsx')
);
...
const LazyRetirementSavingsCalculator = lazy(
  () => import('../calculators/retirement-savings-calculator.jsx')
);
const LazyReverseMortgageCalculator = lazy(
  () => import('../calculators/reverse-mortgage-calculator.jsx')
);
...
const LazySalarySacrificeCalculator = lazy(
  () => import('../calculators/salary-sacrifice-calculator.jsx')
);
...
const LazyStudentLoanRepaymentCalculator = lazy(
  () => import('../calculators/student-loan-repayment-calculator.jsx')
);
const LazySubscriptionCostCalculator = lazy(
  () => import('../calculators/subscription-cost-calculator.jsx')
);
const LazyTimeValueOfMoneyCalculator = lazy(
  () => import('../calculators/time-value-of-money-calculator.jsx')
);
const LazyTipCalculator = lazy(() => import('../calculators/tip-calculator.jsx'));
const LazyTravelBudgetCalculator = lazy(
  () => import('../calculators/travel-budget-calculator.jsx')
);
const LazyVatCalculator = lazy(() => import('../calculators/vat-calculator.jsx'));
const LazyWeddingBudgetCalculator = lazy(
  () => import('../calculators/wedding-budget-calculator.jsx')
);
const LazyWeeklyBudgetPlanner = lazy(() => import('../calculators/weekly-budget-planner.jsx'));
const LazyYearlyIncomeCalculator = lazy(
  () => import('../calculators/yearly-income-calculator.jsx')
);
const LazyZeroBasedBudgetingCalculator = lazy(
  () => import('../calculators/zero-based-budgeting-calculator.jsx')
);
...
const _slugToPageName = (() => {
  ...
  _allCalcs.forEach((calc) => {
    if (!calc) return;
    if (calc.url) {
      const target = (typeof calc.page === 'string' && calc.page.trim()) || undefined;
      ...
      >
        <Routes>
          ...
          <Route
            ...
            element={<LazyPercentageChangeCalculator />}
          />
          <Route
            path="/personal-allowance-calculator"
            element={<LazyPersonalAllowanceCalculator />}
          />
          ...
          <Route
            path="/property-flipping-calculator"
            element={<LazyPropertyFlippingCalculator />}
          />
          ...
          <Route
            ...
            element={<LazyTimeValueOfMoneyCalculator />}
          />
          ...
          <Route
            path="/zero-based-budgeting-calculator"
            element={<LazyZeroBasedBudgetingCalculator />}
          />
          ...
          <Route
            path="/blog/why-small-calculations-matter"
            element={<BlogWhyCalculationsMatter />}
          />
