...
const iFAQs = [
  ...
  },
  {
    ...
    answer:
      'Most estates can pass on up to £325,000 without any IHT being due. This is the Nil-Rate Band.',
  },
  {
    question: 'What is the Residence Nil-Rate Band (RNRB)?',
    answer:
      'The RNRB is an additional threshold of up to £175,000 if you give away your main residence to your children or other direct descendants.',
  },
  {
                ...
                <CardContent>
                  ...
                  <div className="mt-4 text-sm space-y-2">
                    <div className="flex justify-between">
                      ...
                      <strong>£{results.totalThreshold.toLocaleString()}</strong>
                    </div>
                    <div className="flex justify-between">
                      <span>Taxable estate value:</span>{' '}
                      <strong>£{results.taxableAmount.toLocaleString()}</strong>
                    </div>
                  </div>
                </CardContent>
              </Card>
