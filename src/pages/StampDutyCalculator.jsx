...
const sdltFAQs = [
  ...
  },
  {
    ...
    answer:
      'First-time buyers receive relief. In England and NI, they pay no Stamp Duty on properties up to £425,000, and a 5% rate on the portion from £425,001 to £625,000. If the property price is over £625,000, they cannot claim the relief and pay the standard rates.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. For leasehold purchases, SDLT can be due on both the purchase price (premium) and, in some cases, the net present value of the rent (ground rent). Freehold purchases are usually assessed solely on the purchase price. Always check your solicitor’s advice for your specific contract terms.',
  },
];
      ...
      if (band.rate === -1) {
        ...
        for (const stdBand of standardRates) {
          if (price > stdBand.threshold) {
            ...
            if (taxInBand > 0) {
              taxBreakdown.push({
                band: `£${previousThreshold.toLocaleString()} - £${stdBand.threshold.toLocaleString()}`,
            ...
            if (taxInBand > 0) {
              taxBreakdown.push({
                band: `£${previousThreshold.toLocaleString()} - £${price.toLocaleString()}`,
                rate: stdBand.rate * 100,
                tax: taxInBand,
              });
              totalTax += taxInBand;
    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            {hasCalculated && results ? (
              <>
                <div className="flex justify-between items-center non-printable">
                  <Heading as="h2" size="h2" weight="bold" className="text-gray-800">Stamp Duty Result</Heading>
        ...
        <section className="mt-12 bg-white border border-gray-200 rounded-lg p-6 space-y-4">
          <Heading as="h2" size="h2" weight="bold" className="text-gray-900">How this Stamp Duty calculator works</Heading>
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <li>
              Special rules may apply for shared ownership, leasehold ground rent, and mixed‑use or
          ...
          <p className="text-gray-700">
            For a £350,000 next‑home purchase, tax is calculated band‑by‑band. The portion within
