...
const remortgageFAQs = [
  ...
  },
  {
    ...
    answer:
      'LTV is the size of your mortgage in relation to the value of your property. For example, if you have a £150,000 mortgage on a £200,000 property, your LTV is 75%. A lower LTV generally gives you access to better mortgage rates.',
  },
  {
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">£{results.equity.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
