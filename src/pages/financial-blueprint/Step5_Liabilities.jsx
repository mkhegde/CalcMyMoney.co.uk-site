...
const Step5_Liabilities = ({ onBack, onNext, formData, handleChange }) => {
  return (
    <div className="space-y-8">
      <div className="text-center"><h2 className="text-2xl font-bold">Step 5 of 7: What You Owe</h2><p className="mt-2 text-gray-600">Enter the outstanding balance on your major debts. Use '0' if not applicable.</p></div>
