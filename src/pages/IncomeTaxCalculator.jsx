        ...
        <CalculatorWrapper>
          <div className="space-y-6">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              ...
              can see how it is divided across the different tax bands—from the tax-free Personal
            ...
            <p className="text-gray-700 dark:text-gray-300">
              An individual earns £60,000 annually. They use this calculator to understand their
              tax. The tool shows that the first £12,570 is tax-free (Personal Allowance). The next
              portion of their income, from £12,571 to £50,270, is taxed at the Basic Rate of 20%.
              The remaining income, from £50,271 to £60,000, is taxed at the Higher Rate of 40%. The
