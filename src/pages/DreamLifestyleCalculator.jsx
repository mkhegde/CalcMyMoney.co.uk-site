...
const getFunResponse = (total) => {
  if (total >= 100000000) {
    return {
      ...
      message:
        "You're not just rich, you're 'buy a small country' rich! Even the Queen would be impressed. Time to start practicing your royal wave! 👑",
    ...
    return {
      ...
      message:
        "You've entered the stratosphere of wealth! At this level, you probably have people who have people. Don't forget us little people! ✈️",
    ...
    return {
      ...
      message:
        "Welcome to the 'I own my own island' club! You're so rich, your money has money. Time to start your own currency! 🏝️",
    ...
    return {
      ...
      message:
        "You're living like a character from a Jane Austen novel, but with better plumbing! Society parties and fox hunting await! 🦊",
    ...
    return {
      ...
      message:
        "You've got 99 problems, but money ain't one! Your biggest worry is which yacht to take to Monaco. Life is tough! ⛵",
    ...
    return {
      ...
      message:
        "You're officially in 'I have arrived' territory! Time to practice saying 'my people will call your people' with a straight face! 🎭",
    ...
    return {
      ...
      message:
        "Welcome to the millionaire's club! You can now afford to be 'eccentric' instead of 'weird'. Embrace your quirkiness! 🎪",
    ...
    return {
      ...
      message:
        "You're in the 'comfortable' zone! You can afford the good stuff without checking your bank balance first. Living the dream! 😌",
    ...
    return {
      ...
      message:
        'Hey, we all have to start somewhere! Even Jeff Bezos once worried about student loans. Your empire awaits! 🚀',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 printable-grid-cols-1 grid lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6 non-printable">
          <div className="text-center mb-6">
            <Heading as="h2" size="h2" weight="bold" className="text-gray-800">Build Your Fantasy Empire</Heading>
