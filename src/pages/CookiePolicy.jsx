      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card>
          <CardContent className="p-8 space-y-6 text-gray-700 leading-relaxed">
            <Heading as="h2" size="h2" className="text-gray-800">What are cookies?</Heading>
            <p>
            ...
            <Heading as="h2" size="h2" className="text-gray-800 pt-4">How we use cookies</Heading>
            <p>
            ...
            <Heading as="h2" size="h2" className="text-gray-800 pt-4">Managing Cookies</Heading>
            <p>
