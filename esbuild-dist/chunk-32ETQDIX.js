...
var require_baseIsNative = __commonJS({
  "node_modules/lodash/_baseIsNative.js"(exports, module) {
    var isFunction23 = require_isFunction();
    ...
    function baseIsNative(value) {
      ...
      var pattern = isFunction23(value) ? reIsNative : reIsHostCtor;
...
var require_isArrayLike = __commonJS({
  "node_modules/lodash/isArrayLike.js"(exports, module) {
    ...
    function isArrayLike(value) {
      return value != null && isLength(value.length) && !isFunction23(value);
    }
...
function _isNativeReflectConstruct() {
  ...
  return (_isNativeReflectConstruct = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
function _isNativeReflectConstruct2() {
  ...
  return (_isNativeReflectConstruct2 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
function _isNativeReflectConstruct3() {
  ...
  return (_isNativeReflectConstruct3 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
function _isNativeReflectConstruct4() {
  ...
  return (_isNativeReflectConstruct4 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
function combineComparators(comparatorA, comparatorB) {
  return function isEqual7(a2, b, state) {
...
var Layer = /* @__PURE__ */ import_react12.default.forwardRef(function(props, ref) {
  var children = props.children, className = props.className, others = _objectWithoutProperties6(props, _excluded7);
...
var getPath = function getPath2(_ref) {
  ...
  if (Array.isArray(baseLine)) {
    ...
    var areaPoints = formatPoints.map(function(entry, index) {
      return _objectSpread11(_objectSpread11({}, entry), {}, {
...
var Curve = function Curve2(props) {
  ...
  return /* @__PURE__ */ React11.createElement("path", _extends6({}, filterProps(props, false), adaptEventHandlers(props), {
...
function removeInvalidKeys(obj) {
  var copyObj = _objectSpread12({}, obj);
...
var getStringSize = function getStringSize2(text) {
  ...
  try {
    ...
    var measurementSpanStyle = _objectSpread12(_objectSpread12({}, SPAN_STYLE), copyStyle);
...
var DecimalCSS = /* @__PURE__ */ (function() {
  function DecimalCSS2(num, unit2) {
    _classCallCheck6(this, DecimalCSS2);
    this.num = num;
    this.unit = unit2;
    this.num = num;
    this.unit = unit2;
  ...
  return _createClass6(DecimalCSS2, [{
    key: "add",
...
var Text = function Text2(_ref5) {
  var _ref5$x = _ref5.x, propsX = _ref5$x === void 0 ? 0 : _ref5$x, _ref5$y = _ref5.y, propsY = _ref5$y === void 0 ? 0 : _ref5$y, _ref5$lineHeight = _ref5.lineHeight, lineHeight = _ref5$lineHeight === void 0 ? "1em" : _ref5$lineHeight, _ref5$capHeight = _ref5.capHeight, capHeight = _ref5$capHeight === void 0 ? "0.71em" : _ref5$capHeight, _ref5$scaleToFit = _ref5.scaleToFit, scaleToFit = _ref5$scaleToFit === void 0 ? false : _ref5$scaleToFit, _ref5$textAnchor = _ref5.textAnchor, textAnchor = _ref5$textAnchor === void 0 ? "start" : _ref5$textAnchor, _ref5$verticalAnchor = _ref5.verticalAnchor, verticalAnchor = _ref5$verticalAnchor === void 0 ? "end" : _ref5$verticalAnchor, _ref5$fill = _ref5.fill, fill = _ref5$fill === void 0 ? DEFAULT_FILL : _ref5$fill, props = _objectWithoutProperties7(_ref5, _excluded8);
  ...
  var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties7(props, _excluded22);
...
function getValidInterval(_ref) {
  var _ref2 = _slicedToArray7(_ref, 2), min3 = _ref2[0], max4 = _ref2[1];
...
function getNiceTickValuesFn(_ref3) {
  var _ref4 = _slicedToArray7(_ref3, 2), min3 = _ref4[0], max4 = _ref4[1];
  var tickCount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6;
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var count = Math.max(tickCount, 2);
  var _getValidInterval = getValidInterval([min3, max4]), _getValidInterval2 = _slicedToArray7(_getValidInterval, 2), cormin = _getValidInterval2[0], cormax = _getValidInterval2[1];
...
function getTickValuesFn(_ref5) {
  var _ref6 = _slicedToArray7(_ref5, 2), min3 = _ref6[0], max4 = _ref6[1];
  var tickCount = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6;
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var count = Math.max(tickCount, 2);
  var _getValidInterval3 = getValidInterval([min3, max4]), _getValidInterval4 = _slicedToArray7(_getValidInterval3, 2), cormin = _getValidInterval4[0], cormax = _getValidInterval4[1];
  if (cormin === -Infinity || cormax === Infinity) {
    return [min3, max4];
  }
  if (cormin === cormax) {
...
function getTickValuesFixedDomainFn(_ref7, tickCount) {
  var _ref8 = _slicedToArray7(_ref7, 2), min3 = _ref8[0], max4 = _ref8[1];
  var allowDecimals = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
  var _getValidInterval5 = getValidInterval([min3, max4]), _getValidInterval6 = _slicedToArray7(_getValidInterval5, 2), cormin = _getValidInterval6[0], cormax = _getValidInterval6[1];
  if (cormin === -Infinity || cormax === Infinity) {
    return [min3, max4];
  }
  if (cormin === cormax) {
  ...
  var count = Math.max(tickCount, 2);
  var step = getFormatStep(new import_decimal2.default(cormax).sub(cormin).div(count - 1), allowDecimals, 0);
  var values = [].concat(_toConsumableArray5(arithmetic_default.rangeStep(new import_decimal2.default(cormin), new import_decimal2.default(cormax).sub(new import_decimal2.default(0.99).mul(step)), step)), [cormax]);
  return min3 > max4 ? reverse(values) : values;
}
...
function _isNativeReflectConstruct6() {
  ...
  return (_isNativeReflectConstruct6 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var ErrorBar = /* @__PURE__ */ (function(_React$Component) {
  function ErrorBar2() {
    _classCallCheck7(this, ErrorBar2);
    return _callSuper5(this, ErrorBar2, arguments);
  }
  _inherits6(ErrorBar2, _React$Component);
  return _createClass7(ErrorBar2, [{
    key: "render",
    value: function render() {
      var _this$props = this.props, offset = _this$props.offset, layout = _this$props.layout, width = _this$props.width, dataKey = _this$props.dataKey, data = _this$props.data, dataPointFormatter = _this$props.dataPointFormatter, xAxis = _this$props.xAxis, yAxis = _this$props.yAxis, others = _objectWithoutProperties8(_this$props, _excluded9);
      ...
      var errorBars = data.map(function(entry) {
        ...
        return /* @__PURE__ */ import_react14.default.createElement(Layer, _extends8({
          className: "recharts-errorBar",
          key: "bar-".concat(lineCoordinates.map(function(c2) {
            return "".concat(c2.x1, "-").concat(c2.x2, "-").concat(c2.y1, "-").concat(c2.y2);
          }))
        }, svgProps), lineCoordinates.map(function(coordinates) {
          return /* @__PURE__ */ import_react14.default.createElement("line", _extends8({}, coordinates, {
...
_defineProperty14(ErrorBar, "defaultProps", {
  stroke: "black",
  strokeWidth: 1.5,
  width: 5,
  offset: 0,
...
_defineProperty14(ErrorBar, "displayName", "ErrorBar");
...
var getLegendProps = function getLegendProps2(_ref) {
  ...
  var legendProps = legendDefaultProps !== void 0 ? _objectSpread13(_objectSpread13({}, legendDefaultProps), legendItem.props) : {};
  var legendData;
  if (legendItem.props && legendItem.props.payload) {
    ...
    legendData = (formattedGraphicalItems || []).map(function(_ref3) {
      ...
      var itemProps = itemDefaultProps !== void 0 ? _objectSpread13(_objectSpread13({}, itemDefaultProps), item.props) : {};
  ...
  return _objectSpread13(_objectSpread13(_objectSpread13({}, legendProps), Legend.getWithHeight(legendItem, legendWidth)), {}, {
    payload: legendData,
    item: legendItem
  });
};
...
var getMainColorOfGraphicItem = function getMainColorOfGraphicItem2(item) {
  ...
  var defaultedProps = (_item$type = item.type) !== null && _item$type !== void 0 && _item$type.defaultProps ? _objectSpread14(_objectSpread14({}, item.type.defaultProps), item.props) : item.props;
  ...
  for (var i = 0, len = numericAxisIds.length; i < len; i++) {
    ...
    for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
      ...
      if (barItems && barItems.length) {
        ...
        var barItemProps = barItemDefaultProps !== void 0 ? _objectSpread14(_objectSpread14({}, barItemDefaultProps), barItems[0].props) : barItems[0].props;
...
var appendOffsetOfLegend = function appendOffsetOfLegend2(offset, _unused, props, legendBox) {
  ...
  if (legendProps) {
    ...
    if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) {
      return _objectSpread14(_objectSpread14({}, offset), {}, _defineProperty16({}, align, offset[align] + (boxWidth || 0)));
    }
    if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) {
      return _objectSpread14(_objectSpread14({}, offset), {}, _defineProperty16({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
    }
  }
  return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId2(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
  ...
  var stackGroups = items.reduce(function(result, item) {
    var _item$type2;
    var defaultedProps = (_item$type2 = item.type) !== null && _item$type2 !== void 0 && _item$type2.defaultProps ? _objectSpread14(_objectSpread14({}, item.type.defaultProps), item.props) : item.props;
    ...
    return _objectSpread14(_objectSpread14({}, result), {}, _defineProperty16({}, axisId, parentGroup));
  ...
  return Object.keys(stackGroups).reduce(function(result, axisId) {
    ...
    if (group.hasStack) {
      ...
      group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
        ...
        return _objectSpread14(_objectSpread14({}, res), {}, _defineProperty16({}, stackId, {
          numericAxisId,
          cateAxisId,
          items: g.items,
    ...
    return _objectSpread14(_objectSpread14({}, result), {}, _defineProperty16({}, axisId, group));
...
var getStackedDataOfItem = function getStackedDataOfItem2(item, stackGroups) {
  var _item$type3;
  var defaultedProps = (_item$type3 = item.type) !== null && _item$type3 !== void 0 && _item$type3.defaultProps ? _objectSpread14(_objectSpread14({}, item.type.defaultProps), item.props) : item.props;
...
var getTooltipItem = function getTooltipItem2(graphicalItem, payload) {
  var defaultedProps = graphicalItem.type.defaultProps ? _objectSpread14(_objectSpread14({}, graphicalItem.type.defaultProps), graphicalItem.props) : graphicalItem.props;
  ...
  return _objectSpread14(_objectSpread14({}, filterProps(graphicalItem, false)), {}, {
    dataKey,
    unit: unit2,
    formatter,
    name: name || dataKey,
...
var formatAxisMap = function formatAxisMap2(props, axisMap, offset, axisType, chartName) {
  ...
  return ids.reduce(function(result, id) {
    ...
    var ticks2 = getTicksOfScale(scale, _objectSpread15(_objectSpread15({}, axis), {}, {
      realScaleType
    }));
    var finalAxis = _objectSpread15(_objectSpread15(_objectSpread15({}, axis), ticks2), {}, {
      range: range6,
      radius: outerRadius,
      realScaleType,
      scale,
    ...
    return _objectSpread15(_objectSpread15({}, result), {}, _defineProperty17({}, id, finalAxis));
  }, {});
};
...
var inRangeOfSector = function inRangeOfSector2(_ref5, sector) {
  ...
  if (inRange) {
    return _objectSpread15(_objectSpread15({}, sector), {}, {
      radius,
...
var getTickClassName = function getTickClassName2(tick) {
  return !/* @__PURE__ */ (0, import_react15.isValidElement)(tick) && !(0, import_isFunction6.default)(tick) && typeof tick !== "boolean" ? tick.className : "";
};
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel2(props) {
  ...
  if (position === "top") {
    ...
    return _objectSpread16(_objectSpread16({}, attrs), parentViewBox ? {
  ...
  if (position === "bottom") {
    ...
    return _objectSpread16(_objectSpread16({}, _attrs), parentViewBox ? {
  ...
  if (position === "left") {
    ...
    return _objectSpread16(_objectSpread16({}, _attrs2), parentViewBox ? {
  ...
  if (position === "right") {
    ...
    return _objectSpread16(_objectSpread16({}, _attrs3), parentViewBox ? {
...
function Label(_ref4) {
  var _ref4$offset = _ref4.offset, offset = _ref4$offset === void 0 ? 5 : _ref4$offset, restProps = _objectWithoutProperties9(_ref4, _excluded10);
  var props = _objectSpread16({
    offset
  }, restProps);
  var viewBox = props.viewBox, position = props.position, value = props.value, children = props.children, content = props.content, _props$className = props.className, className = _props$className === void 0 ? "" : _props$className, textBreakAll = props.textBreakAll;
  if (!viewBox || (0, import_isNil7.default)(value) && (0, import_isNil7.default)(children) && !/* @__PURE__ */ (0, import_react16.isValidElement)(content) && !(0, import_isFunction7.default)(content)) {
    return null;
  }
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ import_react17.default.createElement(Layer, {
    ...
    return /* @__PURE__ */ import_react17.default.createElement(Label, _extends10({}, filterProps(entry, true), others, idProps, {
      parentViewBox: entry.parentViewBox,
      value,
      textBreakAll,
      viewBox: Label.parseViewBox((0, import_isNil8.default)(clockWise) ? entry : _objectSpread17(_objectSpread17({}, entry), {}, {
        clockWise
      })),
      key: "label-".concat(index),
      index
...
function parseLabelList(label, data) {
  ...
  if (/* @__PURE__ */ import_react17.default.isValidElement(label) || (0, import_isFunction8.default)(label)) {
    return /* @__PURE__ */ import_react17.default.createElement(LabelList, {
      key: "labelList-implicit",
      data,
      content: label
...
var Rectangle = function Rectangle2(rectangleProps) {
  var props = _objectSpread18(_objectSpread18({}, defaultProps), rectangleProps);
  var pathRef = (0, import_react18.useRef)();
  var _useState = (0, import_react18.useState)(-1), _useState2 = _slicedToArray10(_useState, 2), totalLength = _useState2[0], setTotalLength = _useState2[1];
  ...
  return /* @__PURE__ */ import_react18.default.createElement(es6_default, {
    ...
    }, /* @__PURE__ */ import_react18.default.createElement("path", _extends11({}, filterProps(props, true), {
      className: layerClass,
...
var Trapezoid = function Trapezoid2(props) {
  var trapezoidProps = _objectSpread19(_objectSpread19({}, defaultProps2), props);
  var pathRef = (0, import_react19.useRef)();
  var _useState = (0, import_react19.useState)(-1), _useState2 = _slicedToArray11(_useState, 2), totalLength = _useState2[0], setTotalLength = _useState2[1];
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ import_react19.default.createElement("g", null, /* @__PURE__ */ import_react19.default.createElement("path", _extends12({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ import_react19.default.createElement(es6_default, {
    ...
    return /* @__PURE__ */ import_react19.default.createElement(es6_default, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ import_react19.default.createElement("path", _extends12({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
var Sector = function Sector2(sectorProps) {
  var props = _objectSpread20(_objectSpread20({}, defaultProps3), sectorProps);
  ...
  return /* @__PURE__ */ import_react20.default.createElement("path", _extends13({}, filterProps(props, true), {
    className: layerClass,
    d: path2,
    role: "img"
  }));
...
function _isNativeReflectConstruct7() {
  ...
  return (_isNativeReflectConstruct7 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var Pie = /* @__PURE__ */ (function(_PureComponent) {
  function Pie2(props) {
    ...
    _this = _callSuper6(this, Pie2, [props]);
    _defineProperty24(_this, "pieRef", null);
    _defineProperty24(_this, "sectorRefs", []);
    _defineProperty24(_this, "id", uniqueId("recharts-pie-"));
    _defineProperty24(_this, "handleAnimationEnd", function() {
      var onAnimationEnd2 = _this.props.onAnimationEnd;
      _this.setState({
        isAnimationFinished: true
      });
      if ((0, import_isFunction10.default)(onAnimationEnd2)) {
        onAnimationEnd2();
      }
    });
    _defineProperty24(_this, "handleAnimationStart", function() {
      var onAnimationStart2 = _this.props.onAnimationStart;
      _this.setState({
        isAnimationFinished: false
      });
      if ((0, import_isFunction10.default)(onAnimationStart2)) {
        onAnimationStart2();
      }
    });
    _this.state = {
  ...
  return _createClass8(Pie2, [{
    ...
    value: function renderLabels(sectors) {
      ...
      var labels = sectors.map(function(entry, i) {
        ...
        return (
          // eslint-disable-next-line react/no-array-index-key
          /* @__PURE__ */ import_react22.default.createElement(Layer, {
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        return /* @__PURE__ */ import_react22.default.createElement(Layer, _extends14({
        ...
        }), /* @__PURE__ */ import_react22.default.createElement(Shape, _extends14({
    ...
    value: function renderSectorsWithAnimation() {
      ...
      return /* @__PURE__ */ import_react22.default.createElement(es6_default, {
        begin: animationBegin,
        duration: animationDuration,
        isActive: isAnimationActive,
        easing: animationEasing,
        ...
        return /* @__PURE__ */ import_react22.default.createElement(Layer, null, _this3.renderSectorsStatically(stepData));
      });
    }
  }, {
    ...
    value: function renderLabelLineItem(option, props, key) {
      if (/* @__PURE__ */ import_react22.default.isValidElement(option)) {
        return /* @__PURE__ */ import_react22.default.cloneElement(option, props);
      }
      if ((0, import_isFunction10.default)(option)) {
        return option(props);
      }
      var className = clsx_default("recharts-pie-label-line", typeof option !== "boolean" ? option.className : "");
      return /* @__PURE__ */ import_react22.default.createElement(Curve, _extends14({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      if ((0, import_isFunction10.default)(option)) {
        label = option(props);
        if (/* @__PURE__ */ import_react22.default.isValidElement(label)) {
          return label;
        }
      }
      var className = clsx_default("recharts-pie-label-text", typeof option !== "boolean" && !(0, import_isFunction10.default)(option) ? option.className : "");
      return /* @__PURE__ */ import_react22.default.createElement(Text, _extends14({}, props, {
...
_defineProperty24(Pie, "getRealPieData", function(itemProps) {
...
_defineProperty24(Pie, "parseCoordinateOfPie", function(itemProps, offset) {
...
_defineProperty24(Pie, "getComposedData", function(_ref4) {
  ...
  var itemProps = item.type.defaultProps !== void 0 ? _objectSpread22(_objectSpread22({}, item.type.defaultProps), item.props) : item.props;
...
function BarRectangle(props) {
  return /* @__PURE__ */ import_react23.default.createElement(Shape, _extends15({
    shapeType: "rectangle",
...
function _isNativeReflectConstruct8() {
  ...
  return (_isNativeReflectConstruct8 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
  ...
  return _createClass9(Bar2, [{
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ import_react24.default.createElement(BarRectangle, _extends16({
...
function getTicksEnd(sign2, boundaries, getTickSize, ticks2, minTickGap) {
  ...
  var _loop = function _loop2(i2) {
    ...
    if (i2 === len - 1) {
      ...
      result[i2] = entry = _objectSpread26(_objectSpread26({}, entry), {}, {
    ...
    if (isShow) {
      ...
      result[i2] = _objectSpread26(_objectSpread26({}, entry), {}, {
        isShow: true
      });
    }
  };
...
function getTicksStart(sign2, boundaries, getTickSize, ticks2, minTickGap, preserveEnd) {
  ...
  if (preserveEnd) {
    ...
    result[len - 1] = tail = _objectSpread26(_objectSpread26({}, tail), {}, {
    ...
    if (isTailShow) {
      ...
      result[len - 1] = _objectSpread26(_objectSpread26({}, tail), {}, {
        isShow: true
      });
    }
  }
...
function getTicks(props, fontSize, letterSpacing) {
  ...
  var getTickSize = function getTickSize2(content, index) {
    var value = (0, import_isFunction11.default)(tickFormatter) ? tickFormatter(content.value, index) : content.value;
...
function _isNativeReflectConstruct9() {
  ...
  return (_isNativeReflectConstruct9 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var CartesianAxis = /* @__PURE__ */ (function(_Component) {
  function CartesianAxis2(props) {
    ...
    _this = _callSuper8(this, CartesianAxis2, [props]);
    _this.state = {
      fontSize: "",
      letterSpacing: ""
    };
  ...
  return _createClass11(CartesianAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread27(_objectSpread27(_objectSpread27({}, filterProps(this.props, false)), filterProps(axisLine, false)), {}, {
        fill: "none"
      });
      ...
      return /* @__PURE__ */ import_react25.default.createElement("line", _extends17({}, props, {
    ...
    value: (
      ...
      function renderTicks(ticks2, fontSize, letterSpacing) {
        ...
        var finalTicks = getTicks(_objectSpread27(_objectSpread27({}, this.props), {}, {
          ticks: ticks2
        ...
        var items = finalTicks.map(function(entry, i) {
          ...
          }, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /* @__PURE__ */ import_react25.default.createElement("line", _extends17({}, tickLineProps, lineCoord, {
            className: clsx_default("recharts-cartesian-axis-tick-line", (0, import_get5.default)(tickLine, "className"))
          })), tick && CartesianAxis2.renderTickItem(tick, tickProps, "".concat((0, import_isFunction12.default)(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit2 || "")));
        });
    ...
    value: function render() {
      ...
      if ((0, import_isFunction12.default)(ticksGenerator)) {
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ import_react25.default.isValidElement(option)) {
        tickItem = /* @__PURE__ */ import_react25.default.cloneElement(option, _objectSpread27(_objectSpread27({}, props), {}, {
          className: combinedClassName
        }));
      } else if ((0, import_isFunction12.default)(option)) {
        tickItem = option(_objectSpread27(_objectSpread27({}, props), {}, {
          className: combinedClassName
        }));
      } else {
...
function renderLineItem(option, props) {
  ...
  if (/* @__PURE__ */ import_react27.default.isValidElement(option)) {
    ...
    lineItem = /* @__PURE__ */ import_react27.default.createElement("line", _extends18({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function HorizontalGridLines(props) {
  ...
  var items = horizontalPoints.map(function(entry, i) {
    var lineItemProps = _objectSpread28(_objectSpread28({}, props), {}, {
      x1: x2,
      y1: entry,
      x2: x2 + width,
      y2: entry,
...
var defaultVerticalCoordinatesGenerator = function defaultVerticalCoordinatesGenerator2(_ref, syncWithTicks) {
  ...
  return getCoordinatesOfGrid(getTicks(_objectSpread28(_objectSpread28(_objectSpread28({}, CartesianAxis.defaultProps), xAxis), {}, {
...
var defaultHorizontalCoordinatesGenerator = function defaultHorizontalCoordinatesGenerator2(_ref2, syncWithTicks) {
  ...
  return getCoordinatesOfGrid(getTicks(_objectSpread28(_objectSpread28(_objectSpread28({}, CartesianAxis.defaultProps), yAxis), {}, {
...
function CartesianGrid(props) {
  ...
  var propsIncludingDefaults = _objectSpread28(_objectSpread28({}, props), {}, {
  ...
  if ((!horizontalPoints || !horizontalPoints.length) && (0, import_isFunction13.default)(horizontalCoordinatesGenerator)) {
    var isHorizontalValues = horizontalValues && horizontalValues.length;
    var generatorResult = horizontalCoordinatesGenerator({
      yAxis: yAxis ? _objectSpread28(_objectSpread28({}, yAxis), {}, {
    ...
    warn(Array.isArray(generatorResult), "horizontalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof35(generatorResult), "]"));
    if (Array.isArray(generatorResult)) {
      horizontalPoints = generatorResult;
    }
  }
  if ((!verticalPoints || !verticalPoints.length) && (0, import_isFunction13.default)(verticalCoordinatesGenerator)) {
    var isVerticalValues = verticalValues && verticalValues.length;
    var _generatorResult = verticalCoordinatesGenerator({
      xAxis: xAxis ? _objectSpread28(_objectSpread28({}, xAxis), {}, {
    ...
    warn(Array.isArray(_generatorResult), "verticalCoordinatesGenerator should return Array but instead it returned [".concat(_typeof35(_generatorResult), "]"));
  ...
  }, /* @__PURE__ */ import_react27.default.createElement(Background, {
  ...
  }), /* @__PURE__ */ import_react27.default.createElement(HorizontalGridLines, _extends18({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ import_react27.default.createElement(VerticalGridLines, _extends18({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ import_react27.default.createElement(HorizontalStripes, _extends18({}, propsIncludingDefaults, {
    horizontalPoints
  })), /* @__PURE__ */ import_react27.default.createElement(VerticalStripes, _extends18({}, propsIncludingDefaults, {
    verticalPoints
  })));
}
...
var Dot = function Dot2(props) {
  ...
  if (cx === +cx && cy === +cy && r === +r) {
    return /* @__PURE__ */ React26.createElement("circle", _extends19({}, filterProps(props, false), adaptEventHandlers(props), {
      className: layerClass,
      cx,
      cy,
      r
...
function _isNativeReflectConstruct10() {
  ...
  return (_isNativeReflectConstruct10 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var Line = /* @__PURE__ */ (function(_PureComponent) {
  function Line2() {
    ...
    _this = _callSuper9(this, Line2, [].concat(args));
    _defineProperty31(_this, "state", {
      isAnimationFinished: true,
      totalLength: 0
    });
    _defineProperty31(_this, "generateSimpleStrokeDasharray", function(totalLength, length) {
      return "".concat(length, "px ").concat(totalLength - length, "px");
    });
    _defineProperty31(_this, "getStrokeDasharray", function(length, totalLength, lines) {
    ...
    _defineProperty31(_this, "id", uniqueId("recharts-line-"));
    _defineProperty31(_this, "pathRef", function(node) {
  ...
  return _createClass12(Line2, [{
    ...
    value: function renderErrorBar(needClip, clipPathId) {
      ...
      return /* @__PURE__ */ import_react28.default.createElement(Layer, errorBarProps, errorBarItems.map(function(item) {
    ...
    value: function renderCurveStatically(points, needClip, clipPathId, props) {
      ...
      var curveProps = _objectSpread29(_objectSpread29(_objectSpread29({}, filterProps(others, true)), {}, {
        fill: "none",
      ...
      return /* @__PURE__ */ import_react28.default.createElement(Curve, _extends20({}, curveProps, {
    ...
    value: function renderCurve(needClip, clipPathId) {
      ...
      if (isAnimationActive && points && points.length && (!prevPoints && totalLength > 0 || !(0, import_isEqual5.default)(prevPoints, points))) {
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ import_react28.default.createElement(Layer, {
        className: layerClass
      }, needClipX || needClipY ? /* @__PURE__ */ import_react28.default.createElement("defs", null, /* @__PURE__ */ import_react28.default.createElement("clipPath", {
        id: "clipPath-".concat(clipPathId)
        ...
        width: needClipX ? width : width * 2,
        height: needClipY ? height : height * 2
      })), !clipDot && /* @__PURE__ */ import_react28.default.createElement("clipPath", {
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ import_react28.default.isValidElement(option)) {
        ...
        dotItem = /* @__PURE__ */ import_react28.default.createElement(Dot, _extends20({
          key
        }, dotProps, {
          className
        }));
...
_defineProperty31(Line, "displayName", "Line");
_defineProperty31(Line, "defaultProps", {
  xAxisId: 0,
  yAxisId: 0,
  connectNulls: false,
  activeDot: true,
...
_defineProperty31(Line, "getComposedData", function(_ref4) {
...
function _isNativeReflectConstruct11() {
  ...
  return (_isNativeReflectConstruct11 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var Area = /* @__PURE__ */ (function(_PureComponent) {
  function Area2() {
    ...
    _this = _callSuper10(this, Area2, [].concat(args));
    _defineProperty32(_this, "state", {
      isAnimationFinished: true
    });
    _defineProperty32(_this, "id", uniqueId("recharts-area-"));
  ...
  return _createClass13(Area2, [{
    ...
    value: function renderAreaStatically(points, baseLine, needClip, clipPathId) {
      ...
      return /* @__PURE__ */ import_react29.default.createElement(Layer, {
        clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : null
      }, /* @__PURE__ */ import_react29.default.createElement(Curve, _extends21({}, filterProps(others, true), {
        points,
        connectNulls,
        type,
        baseLine,
      ...
      })), stroke !== "none" && /* @__PURE__ */ import_react29.default.createElement(Curve, _extends21({}, filterProps(this.props, false), {
        ...
        fill: "none",
        points
      })), stroke !== "none" && isRange && /* @__PURE__ */ import_react29.default.createElement(Curve, _extends21({}, filterProps(this.props, false), {
        className: "recharts-area-curve",
        layout,
        type,
        connectNulls,
    ...
    value: function renderAreaWithAnimation(needClip, clipPathId) {
      ...
      return /* @__PURE__ */ import_react29.default.createElement(es6_default, {
        ...
        return /* @__PURE__ */ import_react29.default.createElement(Layer, null, /* @__PURE__ */ import_react29.default.createElement("defs", null, /* @__PURE__ */ import_react29.default.createElement("clipPath", {
          id: "animationClipPath-".concat(clipPathId)
        }, _this2.renderClipRect(t))), /* @__PURE__ */ import_react29.default.createElement(Layer, {
    ...
    value: function renderArea(needClip, clipPathId) {
      ...
      if (isAnimationActive && points && points.length && (!prevPoints && totalLength > 0 || !(0, import_isEqual6.default)(prevPoints, points) || !(0, import_isEqual6.default)(prevBaseLine, baseLine))) {
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ import_react29.default.createElement(Layer, {
        className: layerClass
      }, needClipX || needClipY ? /* @__PURE__ */ import_react29.default.createElement("defs", null, /* @__PURE__ */ import_react29.default.createElement("clipPath", {
        id: "clipPath-".concat(clipPathId)
        ...
        width: needClipX ? width : width * 2,
        height: needClipY ? height : height * 2
      })), !clipDot && /* @__PURE__ */ import_react29.default.createElement("clipPath", {
        id: "clipPath-dots-".concat(clipPathId)
      }, /* @__PURE__ */ import_react29.default.createElement("rect", {
        x: left - dotSize / 2,
        y: top - dotSize / 2,
...
_Area = Area;
_defineProperty32(Area, "displayName", "Area");
_defineProperty32(Area, "defaultProps", {
  stroke: "#3182bd",
  fill: "#3182bd",
  fillOpacity: 0.6,
  xAxisId: 0,
...
_defineProperty32(Area, "getBaseValue", function(props, item, xAxis, yAxis) {
...
_defineProperty32(Area, "getComposedData", function(_ref4) {
...
_defineProperty32(Area, "renderDotItem", function(option, props) {
  var dotItem;
  if (/* @__PURE__ */ import_react29.default.isValidElement(option)) {
    ...
    var key = props.key, rest = _objectWithoutProperties17(props, _excluded27);
    dotItem = /* @__PURE__ */ import_react29.default.createElement(Dot, _extends21({}, rest, {
      key,
      className
    }));
  }
...
function _isNativeReflectConstruct12() {
  ...
  return (_isNativeReflectConstruct12 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
function XAxisImpl(_ref) {
  ...
  return (
    ...
    /* @__PURE__ */ React29.createElement(CartesianAxis, _extends22({}, axisOptions, {
...
var XAxis = /* @__PURE__ */ (function(_React$Component) {
  function XAxis2() {
    _classCallCheck14(this, XAxis2);
    return _callSuper11(this, XAxis2, arguments);
  }
  _inherits12(XAxis2, _React$Component);
  return _createClass14(XAxis2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ React29.createElement(XAxisImpl, this.props);
    }
  }]);
})(React29.Component);
_defineProperty33(XAxis, "displayName", "XAxis");
_defineProperty33(XAxis, "defaultProps", {
  allowDecimals: true,
  hide: false,
  orientation: "bottom",
  width: 0,
...
function _isNativeReflectConstruct13() {
  ...
  return (_isNativeReflectConstruct13 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var YAxisImpl = function YAxisImpl2(_ref) {
  ...
  return (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
    /* @__PURE__ */ React30.createElement(CartesianAxis, _extends23({}, axisOptions, {
      className: clsx_default("recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), axisOptions.className),
      viewBox: {
        x: 0,
        y: 0,
...
var YAxis = /* @__PURE__ */ (function(_React$Component) {
  function YAxis2() {
    _classCallCheck15(this, YAxis2);
    return _callSuper12(this, YAxis2, arguments);
  }
  _inherits13(YAxis2, _React$Component);
  return _createClass15(YAxis2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ React30.createElement(YAxisImpl, this.props);
    }
  }]);
})(React30.Component);
_defineProperty34(YAxis, "displayName", "YAxis");
_defineProperty34(YAxis, "defaultProps", {
  allowDuplicatedCategory: true,
  allowDecimals: true,
  hide: false,
  orientation: "left",
...
var generatePrefixStyle = function generatePrefixStyle2(name, value) {
  ...
  var result = PREFIX_LIST.reduce(function(res, entry) {
    return _objectSpread31(_objectSpread31({}, res), {}, _defineProperty35({}, entry + camelName, value));
  }, {});
  result[name] = value;
  return result;
};
...
function _isNativeReflectConstruct14() {
  ...
  return (_isNativeReflectConstruct14 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var Brush = /* @__PURE__ */ (function(_PureComponent) {
  function Brush2(props) {
    ...
    _this = _callSuper13(this, Brush2, [props]);
    _defineProperty36(_this, "handleDrag", function(e) {
      if (_this.leaveTimer) {
    ...
    _defineProperty36(_this, "handleDragEnd", function() {
      _this.setState({
        isTravellerMoving: false,
        isSlideMoving: false
      }, function() {
    ...
    _defineProperty36(_this, "handleLeaveWrapper", function() {
      if (_this.state.isTravellerMoving || _this.state.isSlideMoving) {
        _this.leaveTimer = window.setTimeout(_this.handleDragEnd, _this.props.leaveTimeOut);
      }
    });
    _defineProperty36(_this, "handleEnterSlideOrTraveller", function() {
      _this.setState({
        isTextActive: true
      });
    });
    _defineProperty36(_this, "handleLeaveSlideOrTraveller", function() {
      _this.setState({
        isTextActive: false
      });
    });
    _defineProperty36(_this, "handleSlideDragStart", function(e) {
  ...
  return _createClass16(Brush2, [{
    ...
    value: function handleTravellerMove(e) {
      ...
      this.setState(_defineProperty36(_defineProperty36({}, movingTravellerId, prevValue + delta), "brushMoveStartX", e.pageX), function() {
        if (onChange) {
          if (isFullGap()) {
            onChange(newIndex);
          }
    ...
    value: function handleTravellerMoveKeyboard(direction, id) {
      ...
      this.setState(_defineProperty36({}, id, newScaleValue), function() {
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ import_react30.default.createElement(Text, _extends24({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ import_react30.default.createElement(Text, _extends24({
        textAnchor: "start",
        verticalAnchor: "middle",
...
_defineProperty36(Brush, "displayName", "Brush");
_defineProperty36(Brush, "defaultProps", {
  height: 40,
  travellerWidth: 5,
  gap: 1,
  fill: "#fff",
...
function _isNativeReflectConstruct15() {
  ...
  return (_isNativeReflectConstruct15 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
_defineProperty37(ReferenceDot, "renderDot", function(option, props) {
  ...
  if (/* @__PURE__ */ import_react31.default.isValidElement(option)) {
    dot = /* @__PURE__ */ import_react31.default.cloneElement(option, props);
  } else if ((0, import_isFunction17.default)(option)) {
    dot = option(props);
  } else {
    dot = /* @__PURE__ */ import_react31.default.createElement(Dot, _extends25({}, props, {
      cx: props.cx,
      cy: props.cy,
...
function _isNativeReflectConstruct16() {
  ...
  return (_isNativeReflectConstruct16 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ import_react32.default.isValidElement(option)) {
    line = /* @__PURE__ */ import_react32.default.cloneElement(option, props);
  } else if ((0, import_isFunction18.default)(option)) {
    line = option(props);
  } else {
    line = /* @__PURE__ */ import_react32.default.createElement("line", _extends26({}, props, {
...
function ReferenceLineImpl(props) {
  ...
  var lineProps = _objectSpread34(_objectSpread34({
    clipPath
...
var ReferenceLine = /* @__PURE__ */ (function(_React$Component) {
  function ReferenceLine2() {
    _classCallCheck18(this, ReferenceLine2);
    return _callSuper15(this, ReferenceLine2, arguments);
  }
  _inherits16(ReferenceLine2, _React$Component);
  return _createClass18(ReferenceLine2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ import_react32.default.createElement(ReferenceLineImpl, this.props);
    }
  }]);
...
function _isNativeReflectConstruct17() {
  ...
  return (_isNativeReflectConstruct17 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var ReferenceArea = /* @__PURE__ */ (function(_React$Component) {
  function ReferenceArea2() {
    ...
    return _callSuper16(this, ReferenceArea2, arguments);
  }
  ...
  return _createClass19(ReferenceArea2, [{
    ...
    value: function render() {
      ...
      }, ReferenceArea2.renderRect(shape, _objectSpread35(_objectSpread35({
        clipPath
...
_defineProperty39(ReferenceArea, "renderRect", function(option, props) {
  ...
  if (/* @__PURE__ */ import_react33.default.isValidElement(option)) {
    rect = /* @__PURE__ */ import_react33.default.cloneElement(option, props);
  } else if ((0, import_isFunction19.default)(option)) {
    rect = option(props);
  } else {
    rect = /* @__PURE__ */ import_react33.default.createElement(Rectangle, _extends27({}, props, {
...
var AccessibilityManager = /* @__PURE__ */ (function() {
  ...
  return _createClass20(AccessibilityManager2, [{
    key: "setDetails",
...
var _excluded19 = ["x", "y", "top", "left", "width", "height", "className"];
function _extends28() {
...
var Cross = function Cross2(_ref) {
  var _ref$x = _ref.x, x2 = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y2 = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties18(_ref, _excluded19);
  var props = _objectSpread36({
    x: x2,
    y: y2,
    top,
    left,
  ...
  return /* @__PURE__ */ import_react34.default.createElement("path", _extends28({}, filterProps(props, true), {
...
function _isNativeReflectConstruct18() {
  ...
  return (_isNativeReflectConstruct18 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var getAxisMapByAxes = function getAxisMapByAxes2(props, _ref2) {
  ...
  return axes.reduce(function(result, child) {
    ...
    var childProps = child.type.defaultProps !== void 0 ? _objectSpread38(_objectSpread38({}, child.type.defaultProps), child.props) : child.props;
      ...
      if (dataKey) {
        ...
        if (type === "category" && isCategorical) {
          ...
          if (!allowDuplicatedCategory) {
            domain = parseDomainOfCategoryAxis(childDomain, domain, child).reduce(function(finalDomain, entry) {
              return finalDomain.indexOf(entry) >= 0 || entry === "" || (0, import_isNil13.default)(entry) ? finalDomain : [].concat(_toConsumableArray11(finalDomain), [entry]);
            }, []);
          } else {
            domain = domain.filter(function(entry) {
              return entry !== "" && !(0, import_isNil13.default)(entry);
            });
          }
        } else if (type === "number") {
    ...
    return _objectSpread38(_objectSpread38({}, result), {}, _defineProperty43({}, axisId, _objectSpread38(_objectSpread38({}, childProps), {}, {
      axisType,
      domain,
      categoricalDomain,
      duplicateDomain,
...
var getAxisMapByItems = function getAxisMapByItems2(props, _ref3) {
  ...
  return graphicalItems.reduce(function(result, child) {
    ...
    if (!result[axisId]) {
      ...
      return _objectSpread38(_objectSpread38({}, result), {}, _defineProperty43({}, axisId, _objectSpread38(_objectSpread38({
        axisType
      }, Axis.defaultProps), {}, {
        hide: true,
...
var calculateOffset = function calculateOffset2(_ref5, prevLegendBBox) {
  ...
  var offsetH = Object.keys(yAxisMap).reduce(function(result, id) {
    ...
    if (!entry.mirror && !entry.hide) {
      return _objectSpread38(_objectSpread38({}, result), {}, _defineProperty43({}, orientation, result[orientation] + entry.width));
    }
    return result;
  }, {
    left: margin.left || 0,
  ...
  var offsetV = Object.keys(xAxisMap).reduce(function(result, id) {
    ...
    var orientation = entry.orientation;
    if (!entry.mirror && !entry.hide) {
      return _objectSpread38(_objectSpread38({}, result), {}, _defineProperty43({}, orientation, (0, import_get6.default)(result, "".concat(orientation)) + entry.height));
    }
    return result;
  }, {
    top: margin.top || 0,
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  var getFormatItems = function getFormatItems2(props, currentState) {
    ...
    graphicalItems.forEach(function(item, index) {
      ...
      var itemProps = item.type.defaultProps !== void 0 ? _objectSpread38(_objectSpread38({}, item.type.defaultProps), item.props) : item.props;
      ...
      var axisObj = axisComponents.reduce(function(result, entry) {
        ...
        var axis = axisMap[id];
        return _objectSpread38(_objectSpread38({}, result), {}, _defineProperty43(_defineProperty43({}, entry.axisType, axis), "".concat(entry.axisType, "Ticks"), getTicksOfAxis(axis)));
      }, axisObjInitialValue);
      ...
      if (itemIsBar) {
        ...
        var maxBarSize = (0, import_isNil13.default)(childMaxBarSize) ? globalMaxBarSize : childMaxBarSize;
      ...
      if (composedFn) {
        formattedItems.push({
          props: _objectSpread38(_objectSpread38({}, composedFn(_objectSpread38(_objectSpread38({}, axisObj), {}, {
            ...
            dataStartIndex,
            dataEndIndex
          }))), {}, _defineProperty43(_defineProperty43(_defineProperty43({
  ...
  var updateStateOfAxisMapsOffsetAndStackGroups = function updateStateOfAxisMapsOffsetAndStackGroups2(_ref8, prevState) {
    ...
    var axisObj = axisComponents.reduce(function(result, entry) {
      ...
      return _objectSpread38(_objectSpread38({}, result), {}, _defineProperty43({}, name, getAxisMap(props, _objectSpread38(_objectSpread38({}, entry), {}, {
        graphicalItems,
  ...
  var CategoricalChartWrapper = /* @__PURE__ */ (function(_Component) {
    function CategoricalChartWrapper2(_props) {
      ...
      var _this;
      _classCallCheck21(this, CategoricalChartWrapper2);
      _this = _callSuper17(this, CategoricalChartWrapper2, [_props]);
      _defineProperty43(_this, "eventEmitterSymbol", Symbol("rechartsEventEmitter"));
      _defineProperty43(_this, "accessibilityManager", new AccessibilityManager());
      _defineProperty43(_this, "handleLegendBBoxUpdate", function(box) {
        if (box) {
      ...
      _defineProperty43(_this, "handleReceiveSyncEvent", function(cId, data, emitter) {
      ...
      _defineProperty43(_this, "handleBrushChange", function(_ref9) {
      ...
      _defineProperty43(_this, "handleMouseEnter", function(e) {
        ...
        if (mouse) {
          ...
          if ((0, import_isFunction20.default)(onMouseEnter)) {
            onMouseEnter(_nextState, e);
          }
        }
      });
      _defineProperty43(_this, "triggeredAfterMouseMove", function(e) {
        var mouse = _this.getMouseInfo(e);
        ...
        if ((0, import_isFunction20.default)(onMouseMove)) {
          onMouseMove(nextState, e);
        }
      });
      _defineProperty43(_this, "handleItemMouseEnter", function(el) {
        _this.setState(function() {
          return {
            isTooltipActive: true,
            activeItem: el,
      ...
      _defineProperty43(_this, "handleItemMouseLeave", function() {
        _this.setState(function() {
          return {
            isTooltipActive: false
          };
      ...
      _defineProperty43(_this, "handleMouseMove", function(e) {
        e.persist();
        _this.throttleTriggeredAfterMouseMove(e);
      });
      _defineProperty43(_this, "handleMouseLeave", function(e) {
        ...
        if ((0, import_isFunction20.default)(onMouseLeave)) {
          onMouseLeave(nextState, e);
        }
      });
      _defineProperty43(_this, "handleOuterEvent", function(e) {
        var eventName = getReactEventByType(e);
        var event = (0, import_get6.default)(_this.props, "".concat(eventName));
        if (eventName && (0, import_isFunction20.default)(event)) {
          var _mouse;
          var mouse;
      ...
      _defineProperty43(_this, "handleClick", function(e) {
        var mouse = _this.getMouseInfo(e);
        if (mouse) {
      ...
      _defineProperty43(_this, "handleMouseDown", function(e) {
        var onMouseDown = _this.props.onMouseDown;
        if ((0, import_isFunction20.default)(onMouseDown)) {
          var _nextState3 = _this.getMouseInfo(e);
          onMouseDown(_nextState3, e);
        }
      });
      _defineProperty43(_this, "handleMouseUp", function(e) {
        var onMouseUp = _this.props.onMouseUp;
        if ((0, import_isFunction20.default)(onMouseUp)) {
          var _nextState4 = _this.getMouseInfo(e);
          onMouseUp(_nextState4, e);
        }
      });
      _defineProperty43(_this, "handleTouchMove", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.throttleTriggeredAfterMouseMove(e.changedTouches[0]);
        }
      });
      _defineProperty43(_this, "handleTouchStart", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.handleMouseDown(e.changedTouches[0]);
        }
      });
      _defineProperty43(_this, "handleTouchEnd", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.handleMouseUp(e.changedTouches[0]);
        }
      });
      _defineProperty43(_this, "handleDoubleClick", function(e) {
        var onDoubleClick = _this.props.onDoubleClick;
        if ((0, import_isFunction20.default)(onDoubleClick)) {
          var _nextState5 = _this.getMouseInfo(e);
          onDoubleClick(_nextState5, e);
        }
      });
      _defineProperty43(_this, "handleContextMenu", function(e) {
        var onContextMenu = _this.props.onContextMenu;
        if ((0, import_isFunction20.default)(onContextMenu)) {
          var _nextState6 = _this.getMouseInfo(e);
          onContextMenu(_nextState6, e);
        }
      });
      _defineProperty43(_this, "triggerSyncEvent", function(data) {
        if (_this.props.syncId !== void 0) {
          eventCenter.emit(SYNC_EVENT, _this.props.syncId, data, _this.eventEmitterSymbol);
        }
      });
      _defineProperty43(_this, "applySyncEvent", function(data) {
      ...
      _defineProperty43(_this, "renderCursor", function(element) {
      ...
      _defineProperty43(_this, "renderPolarAxis", function(element, displayName, index) {
        ...
        return /* @__PURE__ */ (0, import_react36.cloneElement)(element, _objectSpread38(_objectSpread38({}, axisOption), {}, {
          className: clsx_default(axisType, axisOption.className),
          key: element.key || "".concat(displayName, "-").concat(index),
          ticks: getTicksOfAxis(axisOption, true)
        }));
      });
      _defineProperty43(_this, "renderPolarGrid", function(element) {
      ...
      _defineProperty43(_this, "renderLegend", function() {
        ...
        return /* @__PURE__ */ (0, import_react36.cloneElement)(item, _objectSpread38(_objectSpread38({}, otherProps), {}, {
          chartWidth: width,
          chartHeight: height,
          margin,
      ...
      _defineProperty43(_this, "renderTooltip", function() {
      ...
      _defineProperty43(_this, "renderReferenceElement", function(element, displayName, index) {
        if (!element) {
          return null;
        }
      ...
      _defineProperty43(_this, "renderActivePoints", function(_ref10) {
        var item = _ref10.item, activePoint = _ref10.activePoint, basePoint = _ref10.basePoint, childIndex = _ref10.childIndex, isRange = _ref10.isRange;
        var result = [];
        var key = item.props.key;
        var itemItemProps = item.item.type.defaultProps !== void 0 ? _objectSpread38(_objectSpread38({}, item.item.type.defaultProps), item.item.props) : item.item.props;
        ...
        if (basePoint) {
          result.push(CategoricalChartWrapper2.renderActiveDot(activeDot, _objectSpread38(_objectSpread38({}, dotProps), {}, {
            cx: basePoint.x,
            cy: basePoint.y
      ...
      _defineProperty43(_this, "renderGraphicChild", function(element, displayName, index) {
        ...
        var graphicalItem = /* @__PURE__ */ (0, import_react36.cloneElement)(element, _objectSpread38(_objectSpread38({}, item.props), itemEvents));
        ...
        if (hasActive) {
          if (activeTooltipIndex >= 0) {
            ...
            if (activeShape || activeBar) {
              ...
              return [/* @__PURE__ */ (0, import_react36.cloneElement)(element, _objectSpread38(_objectSpread38(_objectSpread38({}, item.props), itemEvents), {}, {
                activeIndex
              })), null, null];
            }
            if (!(0, import_isNil13.default)(activePoint)) {
      ...
      _defineProperty43(_this, "renderCustomized", function(element, displayName, index) {
        return /* @__PURE__ */ (0, import_react36.cloneElement)(element, _objectSpread38(_objectSpread38({
          key: "recharts-customized-".concat(index)
        }, _this.props), _this.state));
      });
      _defineProperty43(_this, "renderMap", {
        CartesianGrid: {
          handler: renderAsIs,
          once: true
        },
    ...
    _inherits18(CategoricalChartWrapper2, _Component);
    return _createClass21(CategoricalChartWrapper2, [{
      key: "componentDidMount",
      value: function componentDidMount() {
      ...
      value: function getXScales() {
        ...
        return xAxisMap ? Object.entries(xAxisMap).reduce(function(res, _ref13) {
          ...
          return _objectSpread38(_objectSpread38({}, res), {}, _defineProperty43({}, axisId, axisProps.scale));
        }, {}) : null;
      }
    }, {
      key: "getYScales",
      ...
      value: function render() {
        ...
        if (compact) {
          ...
          }, /* @__PURE__ */ import_react36.default.createElement(Surface, _extends29({}, attrs, {
            width,
            height,
            title,
            desc
        ...
        return /* @__PURE__ */ import_react36.default.createElement(ChartLayoutContextProvider, {
          ...
          height: this.props.height,
          clipPathId: this.clipPathId
        }, /* @__PURE__ */ import_react36.default.createElement("div", _extends29({
  ...
  _defineProperty43(CategoricalChartWrapper, "getDerivedStateFromProps", function(nextProps, prevState) {
    ...
    if (!isChildrenEqual(children, prevState.prevChildren)) {
      ...
      var hasGlobalData = !(0, import_isNil13.default)(data);
  ...
  var CategoricalChart = /* @__PURE__ */ (0, import_react36.forwardRef)(function CategoricalChart2(props, ref) {
    return /* @__PURE__ */ import_react36.default.createElement(CategoricalChartWrapper, _extends29({}, props, {
      ref
    }));
  });
...
var _excluded21 = ["points", "className", "baseLinePoints", "connectNulls"];
function _extends30() {
...
var getSinglePolygonPath = function getSinglePolygonPath2(points, connectNulls) {
  ...
  if (connectNulls) {
    segmentPoints = [segmentPoints.reduce(function(res, segPoints) {
      return [].concat(_toConsumableArray12(res), _toConsumableArray12(segPoints));
    }, [])];
  }
...
var Polygon = function Polygon2(props) {
  var points = props.points, className = props.className, baseLinePoints = props.baseLinePoints, connectNulls = props.connectNulls, others = _objectWithoutProperties20(props, _excluded21);
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ import_react37.default.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ import_react37.default.createElement("path", _extends30({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ import_react37.default.createElement("path", _extends30({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ import_react37.default.createElement("path", _extends30({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ import_react37.default.createElement("path", _extends30({}, filterProps(others, true), {
...
function _isNativeReflectConstruct19() {
  ...
  return (_isNativeReflectConstruct19 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var PolarAngleAxis = /* @__PURE__ */ (function(_PureComponent) {
  function PolarAngleAxis2() {
    _classCallCheck22(this, PolarAngleAxis2);
    return _callSuper18(this, PolarAngleAxis2, arguments);
  }
  _inherits19(PolarAngleAxis2, _PureComponent);
  return _createClass22(PolarAngleAxis2, [{
    key: "getTickLineCoord",
    value: (
      /**
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread39(_objectSpread39({}, filterProps(this.props, false)), {}, {
        fill: "none"
      }, filterProps(axisLine, false));
      if (axisLineType === "circle") {
        return /* @__PURE__ */ import_react38.default.createElement(Dot, _extends31({
      ...
      return /* @__PURE__ */ import_react38.default.createElement(Polygon, _extends31({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        var tickProps = _objectSpread39(_objectSpread39(_objectSpread39({
          textAnchor
        }, axisProps), {}, {
          stroke: "none",
          fill: stroke
        ...
        return /* @__PURE__ */ import_react38.default.createElement(Layer, _extends31({
          className: clsx_default("recharts-polar-angle-axis-tick", getTickClassName(tick)),
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ import_react38.default.createElement("line", _extends31({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ import_react38.default.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ import_react38.default.createElement(Text, _extends31({}, props, {
...
_defineProperty44(PolarAngleAxis, "displayName", "PolarAngleAxis");
_defineProperty44(PolarAngleAxis, "axisType", "angleAxis");
_defineProperty44(PolarAngleAxis, "defaultProps", {
  type: "category",
  angleAxisId: 0,
  scale: "auto",
  cx: 0,
...
var _excluded29 = ["cx", "cy", "angle", "ticks", "axisLine"];
var _excluded210 = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
...
function _isNativeReflectConstruct20() {
  ...
  return (_isNativeReflectConstruct20 = function _isNativeReflectConstruct21() {
    return !!t;
  })();
}
...
var PolarRadiusAxis = /* @__PURE__ */ (function(_PureComponent) {
  function PolarRadiusAxis2() {
    _classCallCheck23(this, PolarRadiusAxis2);
    return _callSuper19(this, PolarRadiusAxis2, arguments);
  }
  _inherits20(PolarRadiusAxis2, _PureComponent);
  return _createClass23(PolarRadiusAxis2, [{
    ...
    key: "renderAxisLine",
    value: function renderAxisLine() {
      var _this$props3 = this.props, cx = _this$props3.cx, cy = _this$props3.cy, angle = _this$props3.angle, ticks2 = _this$props3.ticks, axisLine = _this$props3.axisLine, others = _objectWithoutProperties21(_this$props3, _excluded29);
      var extent = ticks2.reduce(function(result, entry) {
        return [Math.min(result[0], entry.coordinate), Math.max(result[1], entry.coordinate)];
      }, [Infinity, -Infinity]);
      var point0 = polarToCartesian(cx, cy, extent[0], angle);
      var point1 = polarToCartesian(cx, cy, extent[1], angle);
      var props = _objectSpread40(_objectSpread40(_objectSpread40({}, filterProps(others, false)), {}, {
        fill: "none"
      }, filterProps(axisLine, false)), {}, {
        x1: point0.x,
        y1: point0.y,
      ...
      return /* @__PURE__ */ import_react39.default.createElement("line", _extends32({
    ...
    value: function renderTicks() {
      var _this = this;
      var _this$props4 = this.props, ticks2 = _this$props4.ticks, tick = _this$props4.tick, angle = _this$props4.angle, tickFormatter = _this$props4.tickFormatter, stroke = _this$props4.stroke, others = _objectWithoutProperties21(_this$props4, _excluded210);
      var textAnchor = this.getTickTextAnchor();
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ import_react39.default.createElement(Layer, _extends32({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ import_react39.default.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ import_react39.default.createElement(Text, _extends32({}, props, {
...
_defineProperty45(PolarRadiusAxis, "displayName", "PolarRadiusAxis");
_defineProperty45(PolarRadiusAxis, "axisType", "radiusAxis");
_defineProperty45(PolarRadiusAxis, "defaultProps", {
  type: "number",
  radiusAxisId: 0,
  cx: 0,
  cy: 0,
