...
var Tabs2 = Root2;
var TabsList2 = React2.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  List,
  {
    ref,
    className: cn(
...
var TabsTrigger2 = React2.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  Trigger,
  {
    ref,
    className: cn(
...
var TabsContent2 = React2.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
  Content,
  {
    ref,
    className: cn(
