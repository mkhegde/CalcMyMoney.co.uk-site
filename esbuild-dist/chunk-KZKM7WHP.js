...
// src/components/calculators/FAQSection.jsx
var import_react4 = __toESM(require_react(), 1);

// src/components/seo/SeoContext.jsx
var import_react = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var loggedWarnings = /* @__PURE__ */ new Set();
var warnMissingProvider = (methodName = "useSeo") => {
...
var SeoContext = (0, import_react.createContext)(defaultContextValue);
function SeoProvider({ value, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SeoContext.Provider, { value, children });
}
function useSeo() {
...
// src/components/seo/useFaqSchema.js
...
var stripHtmlTags = (value) => typeof value === "string" ? value.replace(/<[^>]*>/g, " ") : "";
var normaliseWhitespace = (value) => value.replace(/\s+/g, " ").trim();
var toPlainText = (value) => {
  ...
  if (import_react2.default.isValidElement(value)) {
    const markup = (0, import_server.renderToStaticMarkup)(value);
...
function FAQSection({
  ...
  (0, import_react4.useEffect)(() => {
    ...
    const removeSchema = () => {
      setSeo((prevOverrides) => {
        ...
        if (Array.isArray(defaults?.jsonLd) && nextJsonLd.length === defaults.jsonLd.length && nextJsonLd.every((schema, index) => schema === defaults.jsonLd[index])) {
          const nextOverrides = { ...prevOverrides };
          delete nextOverrides.jsonLd;
          return nextOverrides;
        }
    ...
    setSeo((prevOverrides) => {
      const baseJsonLd = Array.isArray(prevOverrides?.jsonLd) ? prevOverrides.jsonLd : Array.isArray(defaults?.jsonLd) ? defaults.jsonLd : [];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Card, { className: "border border-card-muted bg-card-muted", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CardHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(CardTitle, { className: "flex items-center gap-2 text-primary", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CircleHelp, { className: "h-5 w-5" }),
      title
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CardContent, { className: "space-y-4", children: faqs.map((faq, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "overflow-hidden rounded-lg border border-card-muted bg-card", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "font-medium text-foreground", children: faq.question }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "px-4 pb-4 pt-1", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "text-sm leading-relaxed text-muted-foreground", children: faq.answer }) }) })
        }
      )
    ] }, index)) })
  ] });
